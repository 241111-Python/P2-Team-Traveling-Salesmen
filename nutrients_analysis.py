...
new_recipe = Recipe(data[0]['name'], data[0]['url'], data[0]['description'], data[0]['ingredients'], data[0]['steps'], data[0]['nutrients'], data[0]['serves'], data[0]['times'], data[0]['dish_type'], data[0]['maincategory'])
print(new_recipe.nutrients['kcal'])
print(kcal_dv(new_recipe))
# print(hours_minutes(new_recipe['times']['Preparation']))
